...
const APP_NAME = "Γ-Universalitäts-Explorer";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Vergleichsrahmen für die GenesisAeon-CREP-Formel Γ = arctanh(η)/σ über AMOC, Amazonas und weitere Paket-Kalibrierungen. Keine bewiesene Naturkonstante.",
      },
